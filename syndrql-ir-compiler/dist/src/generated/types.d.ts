...
export type StatementType = 'select' | 'insert' | 'update' | 'delete' | 'createBundle' | 'dropBundle' | 'updateBundle' | 'createIndex' | 'createView' | 'dropView' | 'refreshView' | 'beginTransaction' | 'commit' | 'rollback' | 'savepoint' | 'rollbackToSavepoint' | 'declareCursor' | 'fetchCursor' | 'closeCursor' | 'prepare' | 'execute' | 'deallocate' | 'createUser' | 'updateUser' | 'deleteUser' | 'createRole' | 'updateRole' | 'deleteRole' | 'grantPermission' | 'grantRole' | 'revokePermission' | 'revokeRole' | 'useDatabase' | 'createDatabase' | 'dropDatabase' | 'renameDatabase' | 'attachDatabase' | 'showDatabases' | 'showBundles' | 'showBundle' | 'showUsers' | 'showSessions' | 'showViews' | 'describeView' | 'showMigrations' | 'showRateLimit' | 'showVersions' | 'showActiveSnapshots' | 'showConflictLog' | 'explainSelect' | 'startMigration' | 'applyMigration' | 'validateMigration' | 'validateRollback' | 'checkpoint' | 'backupDatabase' | 'restoreDatabase' | 'invalidateSession';
export type ExprType = 'binary' | 'literal' | 'identifier' | 'qualified' | 'function' | 'in' | 'notIn' | 'isNull' | 'isNotNull' | 'not' | 'parameter' | 'exists';
