...
// func (db *models.Database) GetBundle(bundleName string) (*models.Bundle, error) {
...
// func (db *models.Database) AddBundle(bundle models.Bundle, dbStore DatabaseStore, bundleStore BundleStore, logger *zap.SugaredLogger) error {
...
// func (db *Database) UpdateBundle(bundleName string, bundle models.Bundle, bundleStore BundleStorageEngine) error {
// 	if _, exists := db.Bundles[bundleName]; !exists {
...
// func (db *Database) ListBundles() []models.Bundle {
// 	var bundleList []models.Bundle
