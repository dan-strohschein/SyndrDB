	...
	return []*models.Document{
		{
			...
			Fields: map[string]models.Field{
				"Name":        {Value: models.NewStringValue("John Doe")},
				"ShortName":   {Value: models.NewStringValue("John")},
				"Email":       {Value: models.NewStringValue("john.doe@company.com")},
				"Phone":       {Value: models.NewStringValue("555-1234")},
				"ProductCode": {Value: models.NewStringValue("PRD-ABC-2024")},
				"Description": {Value: models.NewStringValue("Premium account holder")},
				"Discount":    {Value: models.NewStringValue("50% off")},
				"Active":      {Value: models.NewBoolValue(true)},
				"Message":     {Value: models.NewStringValue("Hello 世界 World")},
				"Emoji":       {Value: models.NewStringValue("Hello😊World")},
			},
		},
		{
			DocumentID: "doc-002",
			Fields: map[string]models.Field{
				"Name":        {Value: models.NewStringValue("Johnny Smith")},
				"ShortName":   {Value: models.NewStringValue("John")},
				"Email":       {Value: models.NewStringValue("johnny@gmail.com")},
				"Phone":       {Value: models.NewStringValue("555-5678")},
				"ProductCode": {Value: models.NewStringValue("PRD-XYZ-2024")},
				"Description": {Value: models.NewStringValue("Standard user account")},
				"Filename":    {Value: models.NewStringValue("test_file.txt")},
				"Active":      {Value: models.NewBoolValue(false)},
			},
		},
		{
			DocumentID: "doc-003",
			Fields: map[string]models.Field{
				"Name":        {Value: models.NewStringValue("Jane Smith")},
				"ShortName":   {Value: models.NewStringValue("Jane")},
				"Email":       {Value: models.NewStringValue("jane.smith@company.com")},
				"Phone":       {Value: models.NewStringValue("555-9012")},
				"ProductCode": {Value: models.NewStringValue("PRD-DEF-2023")},
				"Description": {Value: models.NewStringValue("Premium business account")},
				"Path":        {Value: models.NewStringValue("C:\\Users\\Jane")},
				"Active":      {Value: models.NewBoolValue(true)},
			},
		},
		{
			DocumentID: "doc-004",
			Fields: map[string]models.Field{
				"Name":        {Value: models.NewStringValue("Bob Johnson")},
				"ShortName":   {Value: models.NewStringValue("Bob")},
				"Email":       {Value: models.NewStringValue("admin@company.com")},
				"Phone":       {Value: models.NewStringValue("555-3456")},
				"ProductCode": {Value: models.NewStringValue("PRD-GHI-2023")},
				"Description": {Value: models.NewStringValue("Basic tier membership")},
				"Active":      {Value: models.NewBoolValue(true)},
			},
		},
		{
			DocumentID: "doc-005",
			Fields: map[string]models.Field{
				"Name":        {Value: models.NewStringValue("Alice Williams")},
				"ShortName":   {Value: models.NewStringValue("Alic")},
				"Email":       {Value: models.NewStringValue("alice@example.com")},
				"Phone":       {Value: models.NewStringValue("555-7890")},
				"ProductCode": {Value: models.NewStringValue("PRD-JKL-2022")},
				"Description": {Value: models.NewStringValue("Trial account status")},
				"Active":      {Value: models.NewBoolValue(false)},
			},
		},
	}
