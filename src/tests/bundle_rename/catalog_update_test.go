...
func setupTestEnvironment(t *testing.T) (*database.DatabaseService, *bundle.BundleService, *defaultdb.CatalogService, *zap.SugaredLogger, func()) {
...
func TestBundleRename_UpdatesCatalog(t *testing.T) {
	dbService, bundleService, catalogService, sugar, cleanup := setupTestEnvironment(t)
	defer cleanup()
...
func TestBundleRename_ValidatesNewName(t *testing.T) {
	dbService, bundleService, catalogService, _, cleanup := setupTestEnvironment(t)
	defer cleanup()
