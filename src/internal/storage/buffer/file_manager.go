...
type FileManagerInt interface {
	OpenFile(name string) (uint32, error)
	ReadPage(fileID uint32, pageNum uint32) ([]byte, error)
	WritePage(fileID uint32, pageNum uint32, data []byte) error
