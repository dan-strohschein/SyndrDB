...
func createMemoryTestIndex(t *testing.T, testName string) *BTreeIndex {
	t.Helper()
	...
	config := &IndexConfig{
		DatabaseName: "testdb",
		BundleName:   "leak_test_bundle",
		FieldName:    "test_field",
		DataDir:      testDir,
		IsUnique:     false,
		PageSize:     4096,
		CacheSize:    200, // Increased from 100 to reduce cache thrashing
		FillFactor:   0.7,
		MaxKeyLength: 256,
		SplitRatio:   0.5,
	}
