...
func createRecoveryTestIndex(t *testing.T, testName string) *BTreeIndex {
	t.Helper()
...
func forceCloseWithoutFlush(idx *BTreeIndex) error {
...
func reopenIndex(t *testing.T, indexPath string) *BTreeIndex {
	t.Helper()
...
func validateIndexIntegrity(t *testing.T, idx *BTreeIndex) {
	t.Helper()
