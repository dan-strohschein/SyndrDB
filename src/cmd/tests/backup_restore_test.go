...
func TestNewBackupService(t *testing.T) {
	...
	service := backup.NewBackupService(nil, nil, lockService, nil, logger)
	if service == nil {
		t.Fatal("NewBackupService returned nil")
	}
	// Note: lockService is unexported, so we can't verify it directly
}
...
func TestNewRestoreService(t *testing.T) {
	...
	service := backup.NewRestoreService(nil, nil, lockService, logger)
	if service == nil {
...
func TestLockIntegrationWithBackup(t *testing.T) {
	...
	backupService := backup.NewBackupService(nil, nil, lockService, nil, logger)
...
func TestLockIntegrationWithRestore(t *testing.T) {
	...
	restoreService := backup.NewRestoreService(nil, nil, lockService, logger)
