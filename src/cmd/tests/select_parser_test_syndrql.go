...
func TestSelectParser_SelectAll(t *testing.T) {
	...
	stmt, err := syndrQL.ParseSelect(input, logger)
	if err != nil {
		t.Fatalf("Failed to parse: %v", err)
	}

	if stmt.Pattern != syndrQL.PATTERN_SELECT_ALL {
...
func TestSelectParser_SelectFields(t *testing.T) {
	...
	if stmt.Pattern != syndrQL.PATTERN_SELECT_FIELDS {
...
func TestSelectParser_SimpleWhereClause(t *testing.T) {
	...
	if stmt.Pattern != syndrQL.PATTERN_SELECT_WHERE_SIMPLE {
	...
	binary, ok := stmt.WhereClause.(*syndrQL.BinaryExpression)
	if !ok {
		t.Fatalf("Expected BinaryExpression, got %T", stmt.WhereClause)
	}

	if binary.Operator != syndrQL.TOKEN_GT {
...
func TestSelectParser_ComplexWhereClause(t *testing.T) {
	...
	if stmt.Pattern != syndrQL.PATTERN_SELECT_WHERE_COMPLEX {
...
func TestSelectParser_GroupBy(t *testing.T) {
	...
	if stmt.Pattern != syndrQL.PATTERN_SELECT_GROUPBY {
...
func TestSelectParser_Having(t *testing.T) {
	...
	binary, ok := stmt.Having.(*syndrQL.BinaryExpression)
	if !ok {
...
func TestSelectParser_FunctionCall(t *testing.T) {
	...
	if stmt.Pattern != syndrQL.PATTERN_SELECT_AGGREGATE {
	...
	_, ok := stmt.Fields[0].Expression.(*syndrQL.CallExpression)
	if !ok {
...
func TestSelectParser_MultipleFunctions(t *testing.T) {
	...
	for i, field := range stmt.Fields {
		_, ok := field.Expression.(*syndrQL.CallExpression)
		if !ok {
...
func TestSelectParser_ArithmeticExpression(t *testing.T) {
	...
	binary, ok := stmt.Fields[0].Expression.(*syndrQL.BinaryExpression)
	if !ok {
		t.Fatalf("Expected BinaryExpression, got %T", stmt.Fields[0].Expression)
	}

	if binary.Operator != syndrQL.TOKEN_MULTIPLY {
...
func TestSelectPatternDetector_DetectAllPattern(t *testing.T) {
	...
	if pattern != syndrQL.PATTERN_SELECT_ALL {
...
func TestSelectPatternDetector_DetectFieldsPattern(t *testing.T) {
	...
	if pattern != syndrQL.PATTERN_SELECT_FIELDS {
...
func TestSelectPatternDetector_DetectAggregatePattern(t *testing.T) {
	...
	if pattern != syndrQL.PATTERN_SELECT_AGGREGATE {
...
func TestSelectPatternDetector_DetectGroupByPattern(t *testing.T) {
	...
	if pattern != syndrQL.PATTERN_SELECT_GROUPBY {
...
func TestSelectParser_MissingFrom(t *testing.T) {
	...
	logger := zap.NewExample().Sugar()
	_, err := syndrQL.ParseSelect(input, logger)
	if err == nil {
...
func TestSelectParser_BasicJoin(t *testing.T) {
	...
	if stmt.Pattern != syndrQL.PATTERN_SELECT_JOIN {
	...
	if join.JoinType != syndrQL.InnerJoin {
		t.Errorf("Expected syndrQL.InnerJoin, got %d", join.JoinType)
	}
